...
{
    public struct PerlinNoise : INoise
    {
        /// <summary>
        ...
        public PerlinNoise(int seed, float frequency, Allocator allocator, float amplitude = 1.0f)
        {
            Frequency = frequency;
            Amplitude = amplitude;
            Offset = new int3(0, 0, 0);

            Perm = new PermutationTable(1024, 255, seed, allocator);
        }
